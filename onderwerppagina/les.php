...
<body style="background-color: #33C3FF">
        ...
        <div style="position: absolute; left: 0%; top: 2%;">
         ...
         <!-- zoekfunctie  -->
        <div style="position: absolute; left: 93.5%; top: 0%;">
   		<input type="text" placeholder="Search.." style="color: black"> <!-- Fix dit-->
        </div>
       
            <!-- go back icon linksonderin  -->
            <div style="position: absolute; left: 2%; top: 90%;">
			 ...
			 <div style="position: absolute; left: 8%; top: 90%;">
                <a href="index.php">
            ...
            <!--robot -->
            <div style="position: absolute; left: 70%; top: 9%;">
    ...
    <div class="div-onderwerp">
        ...
        <div style="position: absolute; left: 35%; bottom: -10%;">
